...
func newPostgresStore() *pgstore.PGStore {
	url := "postgres://postgres:postgresss@127.0.0.1:5432/golang_session?sslmode=disable"
...
func main() {
	...
	e.GET("/set", func(c echo.Context) error {
		...
		session.Values["message1"] = "This is hello"
		session.Values["message2"] = "world session"
