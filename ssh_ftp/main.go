...
// 		User:            constant.SSH_USERNAME,
// 		HostKeyCallback: ssh.InsecureIgnoreHostKey,
// 		Auth: []ssh.AuthMethod{
// 			ssh.Password(constant.SSH_PASSWORD),
// 		},
// 	}

// 	client, err := ssh.Dial("tcp", constant.SSH_ADDRESS, sshConfig)
// 	if client != nil {
// 		defer client.Close()
// 	}
// 	if err != nil {
...
func main() {
	...
	fDestination, err := sftpClient.Create("/test/test-file2.txt")
	if err != nil {
